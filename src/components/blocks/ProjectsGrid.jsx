...
function ProjectsGrid() {
  const displayProjects = [
    ...
    },
    {
      ...
      description: "Uitgebreid platform voor Veiligheidsregio Utrecht waar burgers informatie kunnen vinden over veiligheid en incidenten in de provincie Utrecht.",
      image: vruImage,
    ...
    },
    {
      id: 3,
      title: "Dome Auctions",
      description: "Online veilingplatform voor industriële apparatuur waar gebruikers apparatuur kunnen kopen en sellers kunnen verkopen.",
      image: domeImage,
    ...
    },
    {
      id: 5,
      title: "Rent A Pin",
      description: "Platform voor het huren van pinautomaten en een bijbehorende marketing website.",
      image: rapImage,
    ...
    },
    {
      id: 6,
      title: "Rijnland",
      description: "Uitgebreid platform voor Hoogheemraadschap Rijnland waar informatie te vinden is over het waterschap.",
      image: rijnlandImage,
  ...
  return (
    <div className="relative">
      <section className="py-12 md:py-20 text-white relative overflow-hidden" id="projects">
        <div className="container mx-auto mb-16 z-10">
          <div className="text-center">
            ...
            <h2 className="text-5xl md:text-6xl uppercase">Mijn projecten</h2>
            <p className="text-xl text-white/80 max-w-3xl mx-auto mt-6">Verschillende projecten waar ik aan bijgedragen heb.</p>
          </div>
        </div>
